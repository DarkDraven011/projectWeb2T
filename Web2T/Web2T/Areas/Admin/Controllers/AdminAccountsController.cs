...
using Web2T.Areas.Admin.Models;
using Web2T.Models;
...
namespace Web2T.Areas.Admin.Controllers
{
    ...
    public class AdminAccountsController : Controller
    {
        ...
        {
            ViewData["QuyenTruyCap"] = new SelectList(_context.Roles, "RoleId", "RoleName",3);
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("AccountId,Phone,Email,Password,Salt,Active,FullName,RoleId,LastLogin,CreateDate")] Account account)
        {
            try
            {
                if(account.RoleId == null || account.RoleId == 0) account.RoleId = 3; // Khách hàng
        ...
        [HttpPost]
        public IActionResult ChangePassword(ChangePasswordViewModelAdmin model)
        {
